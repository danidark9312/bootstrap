<h3 style="text-align: center">Términos y Condiciones</h3>
...
<h5>ACLARACIÓN:</h5>
<ul>
	<li>Al ingresar a este sitio web usted certifica que entiende y
		comprende, en su totalidad, que los servicios aquí ofrecidos, no
		sustituyen en ningún caso, la apropiada asistencia médica y
		psicológica legal, y que por algún motivo le haya sido recomendada.</li>

	<li>Usted puede lograr un gran cambio en su vida, así mismo, puede
...
<h5>ACUERDO:</h5>
<ul>
	<li>Según legislaciones vigentes, los rituales, videncias y las
		predicciones tienen fines de entretenimiento y/o ayuda personal.</li>
</ul>
</BR>
<h4>FACTURACIÓN:</h4>
</BR>
<h5>COSTO DE LA CONSULTA</h5>

<ul>
	<li>Las consultas a través de nuestro Chat On Line no tendrán
		ningún costo.</li>
	<li>En caso de una Consulta Telefónica, solo aplican los costos
		que le sean facturados por la empresa de telefonía, a la cual usted
		este afiliado, o le facilite el servicio.</li>
</ul>

<h5>COSTO DE LOS SERVICIOS</h5>

<ul>
	<li>El valor de los tratamientos espirituales y demás trabajos que
		soliciten los clientes, varía de acuerdo a los deseos de este mismo,
		problema a resolver, tiempo deseado de acción, y demás variables, que
		serán debidamente explicadas al momento de la consulta, así como le
		costo final.</li>
